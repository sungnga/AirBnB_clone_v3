...
The HTTP request methods used in this project:
...
## RESTful API examples of use
The first endpoint (route) will be to return the status of the API:
...
* To update a `State` object: `PUT /api/v1/states/<state_id>` 
